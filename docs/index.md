---
title: "Learn Docker Free: Beginner to Master Course"
description: "Free Docker containerization course from beginner to advanced -- hands-on lessons with runnable Dockerfile and CLI examples and real capstone projects. Part of a 40-course free learning library."
---
...
A structured, module-wise Docker containerization training program that takes
you from your first `docker run` to production-grade, master-level container
architecture — with runnable Dockerfile and CLI snippets in every module and
a hands-on project at the end of each level.

## How the program is organized

| Level | Focus | Modules |
|-------|-------|---------|
| [Level 1 · Entry](level-1/index.md) | Containers, images, Dockerfiles | 10 topics + 1 project |
| [Level 2 · Intermediate](level-2/index.md) | Compose, caching, debugging | 9 topics + 1 project |
| [Level 3 · Advanced](level-3/index.md) | Networking, security, scale | 9 topics + 1 project |
| [Level 4 · Master](level-4/index.md) | CI/CD, orchestration, architecture | 9 topics + 1 capstone |

## How to use this site

- Work through each level in order — later modules assume earlier ones.
- Every topic page has runnable Dockerfile and `docker`/`docker compose`
  command snippets — copy them into a local project and run them with
